...
SIVERS_SECTIONS = [
    ...
    ("COMPASS 2016 (SIDIS process, proton target), joined across Q-windows", [
        ("compass16.sivers.h-.1<z<2.dpt.dQ", "COMPASS", "mu + p -> mu + h- X (A_UT Sivers)", ""),
        ("compass16.sivers.h-.1<z<2.dx.dQ", "COMPASS", "mu + p -> mu + h- X (A_UT Sivers)", ""),
        ("compass16.sivers.h-.1<z<2.dz.dQ", "COMPASS", "mu + p -> mu + h- X (A_UT Sivers)", ""),
        ("compass16.sivers.h-.1<z.dpt.dQ", "COMPASS", "mu + p -> mu + h- X (A_UT Sivers)", ""),
        ("compass16.sivers.h-.1<z.dx.dQ", "COMPASS", "mu + p -> mu + h- X (A_UT Sivers)", ""),
        ("compass16.sivers.h-.1<z.dz.dQ", "COMPASS", "mu + p -> mu + h- X (A_UT Sivers)", ""),
        ("compass16.sivers.h-.2<z.dpt.dQ", "COMPASS", "mu + p -> mu + h- X (A_UT Sivers)", ""),
        ("compass16.sivers.h-.2<z.dx.dQ", "COMPASS", "mu + p -> mu + h- X (A_UT Sivers)", ""),
        ("compass16.sivers.h-.2<z.dz.dQ", "COMPASS", "mu + p -> mu + h- X (A_UT Sivers)", ""),
        ("compass16.sivers.h+.1<z<2.dpt.dQ", "COMPASS", "mu + p -> mu + h+ X (A_UT Sivers)", ""),
        ("compass16.sivers.h+.1<z<2.dx.dQ", "COMPASS", "mu + p -> mu + h+ X (A_UT Sivers)", ""),
        ("compass16.sivers.h+.1<z<2.dz.dQ", "COMPASS", "mu + p -> mu + h+ X (A_UT Sivers)", ""),
        ("compass16.sivers.h+.1<z.dpt.dQ", "COMPASS", "mu + p -> mu + h+ X (A_UT Sivers)", ""),
...
WGT_SECTIONS = [
    ("COMPASS 2016 pub. (SIDIS process, proton target, 2010 data), joined across Q-windows", [
        ("compass16.wgt.h-.1<z<2.dpt.dQ", "COMPASS", "mu + p -> mu + h- X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h-.1<z<2.dx.dQ", "COMPASS", "mu + p -> mu + h- X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h-.1<z<2.dz.dQ", "COMPASS", "mu + p -> mu + h- X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h-.1<z.dpt.dQ", "COMPASS", "mu + p -> mu + h- X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h-.1<z.dx.dQ", "COMPASS", "mu + p -> mu + h- X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h-.1<z.dz.dQ", "COMPASS", "mu + p -> mu + h- X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h-.2<z.dpt.dQ", "COMPASS", "mu + p -> mu + h- X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h-.2<z.dx.dQ", "COMPASS", "mu + p -> mu + h- X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h-.2<z.dz.dQ", "COMPASS", "mu + p -> mu + h- X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h+.1<z<2.dpt.dQ", "COMPASS", "mu + p -> mu + h+ X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h+.1<z<2.dx.dQ", "COMPASS", "mu + p -> mu + h+ X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h+.1<z<2.dz.dQ", "COMPASS", "mu + p -> mu + h+ X (A_LT^cos(phi_h-phi_S))", ""),
        ("compass16.wgt.h+.1<z.dpt.dQ", "COMPASS", "mu + p -> mu + h+ X (A_LT^cos(phi_h-phi_S))", ""),
